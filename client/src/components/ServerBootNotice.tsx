    ...
    return (
        <section className="grid h-svh w-svw place-content-center overflow-hidden bg-blue-900">
            <div className="relative max-w-2xl overflow-hidden">
                {/* Main content */}
                <div className="relative mx-auto flex max-w-lg flex-col items-center space-y-4 overflow-hidden rounded-2xl border border-white/20 bg-white/10 p-6 text-center text-white shadow-xl backdrop-blur-sm">
                    <Gears />
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <div className="text-center font-mono text-xl leading-none">
                    ...
                    <div className="text-sm text-white/80">
                        ...
                        <p className="mt-2">
                            ...
                            <br />
                            Usually takes less than <strong>1 minute</strong>.
                        </p>
                    </div>
